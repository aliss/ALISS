...
{
    public class ConditionallyRequiredStringValidator :ValidationAttribute
    {
        private readonly string _conditionalPropertyName;
        private readonly object _requiredValue;

        public ConditionallyRequiredStringValidator(string conditionalPropertyName) : base("The field {0} is required")
        {
