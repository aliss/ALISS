...
namespace ALISS.API.Controllers
{
    public partial class ViewController : ApiController
    {
        ...
        [Route("v4/services/{id}")]
        public async Task<HttpResponseMessage> GetServiceById(string id)
        {
            try
            {
        ...
        [Route("v4/organisations/{id}")]
        public async Task<HttpResponseMessage> GetOrganisationById(string id)
        {
            try
            {
