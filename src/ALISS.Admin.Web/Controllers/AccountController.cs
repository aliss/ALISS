...
namespace ALISS.Admin.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    {
                        var userProfile = dc.UserProfiles.FirstOrDefault(u => u.Username == model.Username);
                    ...
                    string currentUser = js.Serialize(currentUserViewModel);
                ...
                default:
                    ModelState.AddModelError("", "The username and password you have entered are incorrect.  Please check and try again, or click \"Forgotten Password/Username?\" below to receive a reminder of your username and reset your password.");
                    ViewBag.ReturnUrl = returnUrl;
                    return View(model);
            }
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            {
                ModelState.AddModelError("NoTAndC", "You must accept the ALISS Terms and Conditions and Privacy Policy to register");
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    await UserManager.AddToRoleAsync(user.Id, RolesEnum.BaseUser.ToString());
                    CurrentUserViewModel currentUserViewModel = new CurrentUserViewModel();
                    ...
                    emailService.SendWelcomeEmail(model.Name, model.Username, model.Email);
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                emailService.SendPasswordResetEmail(user.Email, user.UserName, callbackUrl);
        ...
        private void SetSiteDocs()
        {
            ...
            try
            {
                ...
                ViewBag.AboutClaimedUrl = siteSettingsDocs["About Claimed"];
