...
(function (g, k) {
    ...
    var b = {
            ...
            each: function (a, c, b) {
                if ("[object Object]" === Object.prototype.toString.call(a)) for (var d in a) Object.prototype.hasOwnProperty.call(a, d) && c.call(b, d, a[d], a);
                else {
                    d = 0;
            ...
            rect: function (a, b) {
                var c = window,
                    ...
                    f = b ? c.pageXOffset : 0;
                c = b ? c.pageYOffset : 0;
                return { bottom: d.bottom + c, height: d.height, left: d.left + f, right: d.right + f, top: d.top + c, width: d.width };
            },
        ...
        p = function () {
            if (this.items.length) {
                ...
                a.childElementCount &&
                    (b.removeClass(this.items[this.navIndex], "active"), (this.navIndex = (a.querySelector(".selectr-option.selected") || a.querySelector(".selectr-option")).idx), b.addClass(this.items[this.navIndex], "active"));
        ...
        m = function (a, c) {
            ...
            e = b.createElement("li", { class: "selectr-option", html: e, role: "treeitem", "aria-selected": !1 });
            e.idx = a.idx;
            this.items.push(e);
        ...
        u = function () {
            ...
            this.selected = b.createElement("div", { class: "selectr-selected", disabled: this.disabled, tabIndex: 0, "aria-expanded": !1 });
            ...
            this.tree = b.createElement("ul", { class: "selectr-options", role: "tree", "aria-hidden": !0, "aria-expanded": !1 });
            this.notice = b.createElement("div", { class: "selectr-notice" });
            this.el.setAttribute("aria-hidden", !0);
            this.disabled && (this.el.disabled = !0);
            this.el.multiple &&
                (b.addClass(this.label, "selectr-tags"), b.addClass(this.container, "multiple"), (this.tags = []), (this.selectedValues = this.getSelectedProperties("value")), (this.selectedIndexes = this.getSelectedProperties("idx")));
            this.selected.appendChild(this.label);
            this.config.clearable && ((this.selectClear = b.createElement("button", { class: "selectr-clear", type: "button" }), this.selectClear.innerHTML="Clear"), this.container.appendChild(this.selectClear), b.addClass(this.container, "clearable"));
            ...
            this.config.searchable &&
                ...
                (newLabel = b.createElement("label", {
                    for: "selectr-input",
                    class: "selectr-title"
                }), newLabel.innerHTML = "Filter options"),
                ...
                this.inputContainer.appendChild(newLabel),
            ...
            this.el.children.length &&
                b.each(
                    ...
                    function (a, c) {
                        "OPTGROUP" === c.nodeName
                            ? ((e = b.createElement("ul", { class: "selectr-optgroup", role: "group", html: "<li class='selectr-optgroup--label'>" + c.label + "</li>" })),
                              b.each(
                                  c.children,
                                  function (a, b) {
                                      b.idx = d;
                    ...
                    function (a, c) {
                        k(c, "children")
                            ? ((f = b.createElement("optgroup", { label: c.text })),
                              (e = b.createElement("ul", { class: "selectr-optgroup", role: "group", html: "<li class='selectr-optgroup--label'>" + c.text + "</li>" })),
                              b.each(
                                  c.children,
                                  function (a, b) {
                            ...
                            : ((h = new Option(c.text, c.value, !1, c.hasOwnProperty("selected") && !0 === c.selected)), (h.disabled = k(c, "disabled")), this.options.push(h), (h.idx = d), m.call(this, h, c), (this.data[d] = c), d++);
                    },
                    this
                );
            }
        ...
        v = function (a) {
            ...
            if (this.items.length && this.opened && b.includes([13, 38, 40], a.which)) {
                ...
                d
                    ? (0 === this.navIndex ? (this.tree.scrollTop = 0) : a.top + a.height > this.optsRect.top + this.optsRect.height && (this.tree.scrollTop += a.top + a.height - (this.optsRect.top + this.optsRect.height)),
        ...
        r = function () {
            ...
            if (a.scrollTop >= a.scrollHeight - a.offsetHeight && this.pageIndex < this.pages.length) {
                ...
                a.appendChild(c);
                this.pageIndex++;
                this.emit("selectr.paginate", { items: this.items.length, total: this.data.length, page: this.pageIndex, pages: this.pages.length });
            }
        },
        q = function () {
            if (this.config.searchable || this.config.taggable)
                (this.input.value = null),
                    ...
                    b.hasClass(this.container, "notice") && (b.removeClass(this.container, "notice"), b.addClass(this.container, "open"), this.input.focus()),
                    b.each(
                        this.items,
                        function (a, c) {
    ...
    g = function (a, b) {
        this.defaultConfig = {
            ...
            messages: { noResults: "No results.", noOptions: "No options available.", maxSelections: "A maximum of {max} items can be selected.", tagDuplicate: "That tag is already in use." },
        };
        ...
        if (this.config.nativeKeyboard) {
            ...
            this.selected.addEventListener("keydown", function (b) {
                if (!(a.disabled || a.selected !== document.activeElement || b.altKey || b.ctrlKey || b.metaKey))
                    if (" " === b.key || (!a.opened && -1 < ["Enter", "ArrowUp", "ArrowDown"].indexOf(b.key))) a.toggle(), b.preventDefault(), b.stopPropagation();
                ...
                if (a.config.taggable && this.value.length) {
                    ...
                    if (13 === c.which || b.includes(a.tagSeperators, c.key))
                        b.each(a.tagSeperators, function (a, b) {
                            ...
                            a.add({ value: d, text: d, selected: !0 }, !0) ? (a.close(), q.call(a)) : ((this.value = ""), a.setMessage(a.config.messages.tagDuplicate));
                }
            });
    ...
    g.prototype.setSelected = function (a) {
        this.config.data ||
            ...
            (0 !== this.el.selectedIndex || this.el.options[0].defaultSelected || this.config.defaultSelected || (this.el.selectedIndex = -1),
                ...
                if (this.selectedIndexes.length) {
                    ...
                    b.each(
                        ...
                        function (a, b) {
                            ...
                            e.values[a] = { value: c.value, text: c.textContent };
                        },
                        this
                    );
                }
    ...
    g.prototype.remove = function (a) {
        ...
        Array.isArray(a)
            ...
            : b.isInt(a)
            ? c.push(this.getOptionByIndex(a))
            : "string" === typeof a && c.push(this.getOptionByValue(a));
        if (c.length) {
            var e;
            b.each(
                c,
                ...
                b.each(
                    ...
                    function (c, h) {
                        ...
                        if (g(h.textContent.trim().toLowerCase(), a) && !h.disabled) {
                            if ((d.push({ text: h.textContent, value: h.value }), e && (n(k, f, this.customOption), b.removeClass(k, "excluded"), !this.customOption))) {
