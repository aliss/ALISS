"""
ESPaginator and ESPageNumberPagination inspired by:
https://github.com/mozilla/zamboni/blob/master/mkt/api/paginator.py
"""
...
class ESPageNumberPagination(pagination.PageNumberPagination):
    page_size = 10
