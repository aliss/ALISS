...
class OrganisationForm(forms.ModelForm):
    class Meta:
        ...
        help_texts = {
            ...
            'phone': _("Please enter a valid UK phone number consisting of 10-14 digits only. The most appropriate email address for someone to contact the organisation with."),
